...
public interface HeaderFactory {
     ...
     */
    public List<Header> createHeaders(String headers) throws ParseException;
   ...
   /**
    ...
    /**
     * Creates a new TargetDialog callId
     *
     * @param callId the new string value of the call-id.
     ...
     */
    /**
     * PC 2.0 - Change the parameter from type float to String
     */
