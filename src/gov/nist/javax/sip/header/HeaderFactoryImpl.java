...
public class HeaderFactoryImpl implements HeaderFactory {
	...
	*/
	...
	public AuthenticationInfoHeader createAuthenticationInfoHeader(String response)
		throws ParseException {
// PC 2.0		if (response == null)
// PC 2.0			throw new NullPointerException("null arg response");
		AuthenticationInfo auth = new AuthenticationInfo();
// PC 2.0		auth.setResponse(response);
	...
	*/
	 ...
	 */
	public ServerHeader createServerHeader(List<String> product)
		throws ParseException {
		if (product == null)
	...
	/**
	 * Creates a new TargetDialogHeader based on the newly supplied callId value. 
	 * 
	 * @param callId - the new string value of the call-id.
	 * @throws ParseException which signals that an error has been reached
	 * unexpectedly while parsing the callId value.
	 * @return the newly created CallIdHeader object.
	 */
	/** PC 2.0 Add the creation of this header to the stack.
     * 
     */
	public TargetDialogHeader createTargetDialogHeader(String callId)
		throws ParseException {
		if (callId == null)
			throw new NullPointerException("null arg callId");
		TargetDialog td = new TargetDialog();
		td.setCallId(callId);
		return td;
	}
	 ...
	 */
	/**
	 * PC 2.0 - Change the timeStamp parameter to a String 
	 */public TimeStampHeader createTimeStampHeader(String timeStamp)
		throws InvalidArgumentException {
		if (timeStamp == null)
	 ...
	 */
	public UserAgentHeader createUserAgentHeader(List<String> product)
		throws ParseException {
