...
public interface SessionDescription extends Serializable, Cloneable{
     ...
     */    
    public Vector<TimeDescriptionImpl> getTimeDescriptions(boolean create)
                           throws SdpException;
     ...
     * @throws SdpException if the vector is null
     */    
    public void setTimeDescriptions(Vector<TimeDescriptionImpl> times)
                         throws SdpException;
     ...
     */    
    public Vector<MediaDescriptionImpl> getMediaDescriptions(boolean create)
                            throws SdpException;
