 ...
 */
public class SIPHeaderList extends SIPHeader implements java.util.List<Object> {
	 ...
	 *	sip headers.
	 */
	public LinkedList<String> getHeadersAsEncodedStrings() {
	...
	public void removeAll(Class cl) {
		...
		ListIterator<SIPHeader> li = ll.listIterator();
		while (li.hasNext()) {
			SIPHeader sh = li.next();
			hlist.remove(sh);
		}
	}
