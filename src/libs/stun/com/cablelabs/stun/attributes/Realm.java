...
public class Realm extends StunAttribute {

	public Realm(char type, byte [] val ) throws IllegalArgumentException {
		super(type,val);
		setValue(val);
	}
	
	public Realm(byte [] val) throws IllegalArgumentException {
		super(StunConstants.REALM_TYPE, val);
		setValue(val);
	}
