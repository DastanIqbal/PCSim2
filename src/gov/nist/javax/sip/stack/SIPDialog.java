...
public class SIPDialog implements javax.sip.Dialog, PendingRecord {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1018573764214175737L;
    ...
    protected Hashtable<Integer, NistSipMessageHandlerImpl> pendingRecords;
    ...
    public boolean isRequestConsumable(SIPRequest dialogRequest) {
        ...
        if (this.getRemoteSequenceNumber() == -1)
            ...
            // PC 2.0 change test to be less than
        	//return this.nextSeqno.intValue() == dialogRequest.getCSeq()
            //        .getSequenceNumber();
        	return this.getRemoteSequenceNumber() < dialogRequest.getCSeq()
                   .getSequenceNumber();
    }
...
//    }
        ...
        if (tr != null) {
            if (tr.getCSeq() == sipRequest.getCSeq().getSequenceNumber()) {
                ...
                if (LogWriter.needsLogging) {
                    ...
                    // PC 2.0 LogWriter no longer supports lineCount
	...
	public Iterator<RouteList> getRouteSet() {
	...
	private synchronized RouteList getRouteList() {
		...
		ListIterator<Route> li = routeList.listIterator(routeList.size());
        boolean flag = true;
     ...
     */
    protected SIPDialog() {
        this.pendingRecords = new Hashtable<Integer, NistSipMessageHandlerImpl>();
        this.routeList = new RouteList();
