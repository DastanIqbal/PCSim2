 ...
 *
 */
public class RelayAddress extends AddressAttribute {

	protected byte [] transactionId = null;
	
	public RelayAddress(char type, byte [] transactionID) throws IllegalArgumentException {
		super(type, null);
		this.transactionId = transactionID;
	}
	
	public RelayAddress(byte [] val, byte [] transactionID) throws IllegalArgumentException {
		super(StunConstants.RELAY_ADDRESS_TYPE, val);
		this.transactionId = transactionID;
	}
	public RelayAddress(char type, byte [] val, byte [] transactionID ) throws IllegalArgumentException {
		super(type, val);
		this.transactionId = transactionID;
	}
	
	public RelayAddress(char type, char family, int port, byte [] addr, byte [] transactionID ) throws IllegalArgumentException {
	...
	public RelayAddress(char type, char family, int port, 
