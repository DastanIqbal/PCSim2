...
public class StraightArrow extends Arrow {
	...
	public void draw(Graphics g) {
		...
		Font font = g.getFont();
		Font newFont = new Font(font.getName(), Font.BOLD /*| Font.ITALIC*/, 12);
		g.setFont(newFont);
...
//		}
		...
		if (xmax > xmin) {
		    ...
		    p.addPoint(xmin, y-yUp);
            p.addPoint(xmax-arrowBack, y-yUp);
            p.addPoint(xmax-arrowBack, y-arrowTipY);
            
            p.addPoint(xmax, y);
            
            p.addPoint(xmax-arrowBack, y+arrowTipY);
            p.addPoint(xmax-arrowBack, y+yDown);
            p.addPoint(xmin, y+yDown);
...
//            y + 1);
		...
		g.drawString(
            ...
            g.drawString(
                ...
                y + g.getFontMetrics(g.getFont()).getAscent()+1);
