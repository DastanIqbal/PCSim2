...
public class ResponseEvent extends EventObject {
    ...
    */
    public ResponseEvent(Object source, ClientTransaction clientTransaction, 
    		Response response, String peerAddr, int port, int seq,
    		String trans) {
        super(source);
        m_response = response;
    ...
    */
    ...
    /**
     * Gets the source InetAddress of the Response message
     * @since PC 2.0
     */
    ...
    /**
     * Gets the source port of the Response message
     * @since PC 2.0
     */
    ...
    /**
     * Gets the sequence number of the Response message
     * @since PC 2.0
     */
    ...
    /**
     * Gets the transport protocol of the Response message
     * @since PC 2.0
     */
