...
public class SipStackImpl
	...
	private Hashtable<String, ListeningPoint> listeningPoints;
	...
	*/
	...
	protected SipStackImpl() {
		...
		this.listeningPoints = new Hashtable<String, ListeningPoint>();
...
// PC 2.0 Application layer handles creation of the log file
/*		String debugLog =
...
*/
        ...
        // PC 2.0 Remove the following code for STUN since it does
        // Match the requirements of the Platform and to eliminate
        // any confusion for its use
/*	        String stunAddr = 
			configurationProperties.getProperty(
      ...
      // PC 2.0 add support for Embedded Stun processing
      String embeddedStun = configurationProperties.getProperty(
			  "gov.nist.javax.sip.EMBEDDED_STUN");	
	  if (embeddedStun.equalsIgnoreCase("true") ||
			  embeddedStun.equalsIgnoreCase("on") ||
			  embeddedStun.equalsIgnoreCase("enable")) {
		  super.embeddedStun = true;
	  }
	  
	// PC 2.0 add support for Embedded Stun processing
      String compressStun = configurationProperties.getProperty(
			  "gov.nist.javax.sip.COMPRESS_STUN");	
	  if (compressStun.equalsIgnoreCase("true") ||
			  compressStun.equalsIgnoreCase("on") ||
			  compressStun.equalsIgnoreCase("enable")) {
		  super.compressStunMsg = true;
	  }
		...
		// PC 2.0 String flagStr = configurationProperties.getProperty("gov.nist.javax.sip.STRIP_ROUTE_HEADER");
		// PC 2.0 make this value always false;
		this.stripRouteHeader = false; // true;
...
// PC 2.0 We don't care if it is in use delete it no matter what if the method
// is called 
...
//		}
	 ...
	 */
	public java.util.Iterator<ListeningPoint> getListeningPoints() {
	 ...
	 */
	public java.util.Iterator<SipProvider> getSipProviders() {
