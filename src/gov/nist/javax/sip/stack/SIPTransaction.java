...
public abstract class SIPTransaction
	...
	private Set<SIPTransactionEventListener> eventListeners;
	...
	*/
	...
	final void fireTimer() {
	    ...
	    if ( LogWriter.needsLogging && this instanceof SIPClientTransaction) {
	        // PC 2.0 change the log message below to trace level
	    	sipStack.getLogWriter().logTrace("fireTimer " + this 
		...
		throws IOException
	{
		...
		(messageToSend, sipStack.getLogWriter().getSequencer(),
