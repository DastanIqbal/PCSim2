...
public class SdpFactory extends Object {
	...
	protected static Vector<SessionDescription> sessionDescriptionsList;
    
    /** Creates new SdpFactory */
	public SdpFactory() {
        sessionDescriptionsList=new Vector<SessionDescription>();
    }
     ...
     */    
    public static Vector<SessionDescription> findSessions(String source) {
