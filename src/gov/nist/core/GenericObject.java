...
public abstract class GenericObject implements Serializable, Cloneable {
	...
	// PC 2.0 add datatype to remove compiler warning
	protected static final Set<Object> immutableClasses = new HashSet<Object>(10);
	...
	public static Object makeClone(Object obj) {
		...
		if (immutableClasses.contains (c))
			...
			// invoke it
			try {
				// PC 2.0 added cast to Class [] and Object [] in 
				// the two statements below to remove compiler warnings
	...
	public void merge(Object mergeObject) {
		...
		while (true) {
			...
			for (int i = 0; i < fields.length; i++) {
				...
				// PC 2.0 Compiler warning never used
