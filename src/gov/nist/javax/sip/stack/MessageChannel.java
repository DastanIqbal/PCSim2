...
public abstract class MessageChannel {
	 ...
	 */
	// PC 2.0 made this method public protected abstract void sendMessage(
	...
	*/
	...
	protected void logMessage(
		...
		int port,
		long time) {
		// PC 2.0 change if statement to reflect new log processing
		//if (! getSIPStack().serverLog.needsLogging(ServerLog.TRACE_MESSAGES)) return;
		if (! getSIPStack().serverLog.needsLogging()) return;
