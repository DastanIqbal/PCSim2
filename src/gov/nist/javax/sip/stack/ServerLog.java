...
//		this.logger = new LogAPI(); // Logger.getLogger(SIPMessageStack.class);
...
/*		this.logFileName = 
	...
	public void checkLogFile() {
    	logger.debug(PC2LogCategory.SIP, subCat,
				...
				"\n" );
				logger.debug(PC2LogCategory.SIP, subCat, " ]]> ");
				logger.debug(PC2LogCategory.SIP, subCat, "</debug>");
				logger.debug(PC2LogCategory.SIP, subCat,
					"<description\n logDescription=\""
						+ description
						+ "\"\n name=\""
						...
						+ "\"/>\n ");
				logger.debug(PC2LogCategory.SIP, subCat, "<debug>");
				logger.debug(PC2LogCategory.SIP, subCat, "<![CDATA[ ");
	...
	public boolean needsLogging(int logLevel) {
		...
		return (logger.isDebugEnabled(PC2LogCategory.SIP, subCat) || 
