 ...
 *
 */
public class PeerAddress extends AddressAttribute {

	protected byte [] transactionId = null;

	public PeerAddress(char type, byte [] transactionID) throws IllegalArgumentException {
		super(type, null);
		this.transactionId = transactionID;
	}

	public PeerAddress(byte [] val, byte [] transactionID) throws IllegalArgumentException {
		super(StunConstants.PEER_ADDRESS_TYPE, val);
		this.transactionId = transactionID;
	}
	public PeerAddress(char type, byte [] val, byte [] transactionID ) throws IllegalArgumentException {
		super(type, val);
		this.transactionId = transactionID;
	}

	public PeerAddress(char type, char family, int port, byte [] addr, byte [] transactionID ) throws IllegalArgumentException {
	...
	public PeerAddress(char type, char family, int port, 
