...
public abstract class SIPTransactionStack extends SIPMessageStack implements
	...
	private List<SIPClientTransaction> clientTransactions;

	// Collection or current server transactions
	private List<SIPServerTransaction> serverTransactions;

	// Table of dialogs.
	protected Hashtable<String, SIPDialog> dialogTable;
	...
	private HashSet<SIPServerTransaction> pendingTransactions;

	private List<PendingRecord> pendingRecords;

	// hashtable for fast lookup
	private Hashtable<String, SIPTransaction> clientTransactionTable;

	private Hashtable<String, SIPTransaction> serverTransactionTable;
