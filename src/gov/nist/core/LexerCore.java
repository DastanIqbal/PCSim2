...
public class LexerCore extends StringTokenizer {
	...
	protected static Hashtable<String, Hashtable<String, Integer>> lexerTables;
	...
	static {
		...
		lexerTables = new Hashtable<String, Hashtable<String, Integer>>();
	}
	...
	protected Hashtable<String, Integer> addLexer(String lexerName) {
