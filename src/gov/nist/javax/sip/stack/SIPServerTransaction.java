...
public class SIPServerTransaction extends SIPTransaction implements
    ...
    private LinkedList<PendingRequest> pendingRequests;
    ...
    class SendTrying extends TimerTask {
        ...
        public void run() {
//        	 PC 2.0 - We don't want the stack to send any message without it being
//        	 application driven. Block out the code so nothing happens
