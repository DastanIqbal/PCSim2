...
//	 PC 2.0 - Changed this method to retrieve the nc parameter as 
	...
	public String getNonceCount() {
		...
		return this.getParameter(ParameterNames.NONCE_COUNT);
	}
	...
	public void setNonceCount(String nonceCount) throws ParseException {
		...
		String nc = nonceCount; //Integer.toHexString(nonceCount);
			...
			if (name.equalsIgnoreCase(ParameterNames.QOP)
				...
				if (value.startsWith(Separators.DOUBLE_QUOTE))
					throw new ParseException(
						...
						0);
				//nv.setQuotedValue();
				if ((this instanceof AuthenticationInfo) && name.equalsIgnoreCase(ParameterNames.QOP)) {
